    ...
    public class DataEditorScene : AScene {
        ...
        override public void OnMapClicked(int posx, int posy) {
            ...
            if (modalId == 0) {
                ...
                panel.transform.Find("btnCurrentModal").Find("Image").GetComponent<Image>().sprite = Modal.GetResourceBaseSprite(modalId);
            ...
            switch (part) {
                case 0:
                    if (ArmyAnt.Manager.IOManager.RemoveFolder("MapData")) {
                        ShowTips("Clean map json files successful");
                    } else {
                        ShowTips("Clean map json files failed");
                    }
                    break;
                case 1:
                    OnModalSelected(0);
