...
namespace MagicTower.Components.Unit
{
    ...
    public class Zzhit : ObjectPool.AViewUnit
    {
        ...
        public void SetParam(Model.WeaponData data, bool crit)
        {
            this.data = data;
            isCrit = crit;
        }
        ...
        {
            Present.Manager.AudioManager.PlaySound(isCrit ? data.critAudioId : data.audioId);
        }
