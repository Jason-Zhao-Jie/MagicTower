...
4. 有如下关键事项需要接下来完成:
    ...
    + 设置界面需要继续添加必要的设置项, 并实现所有的设置项, 需要仔细检查并修正设置界面所有元素的适配对齐, 尤其是字体大小的适配
    + 需要完成 Readme 的文本内容
    + 需要全面整理数据编辑器的功能
...
2. 检查了一下适配相关的情况, 处理了一下适配问题. 目前适配方面仍存在较大问题, 可能需要集中处理. 目前记录一些零散的适配问题情况:
    + 存读档界面的item需要添加 vertical layout group
    + 所有界面的字体大小
    + 说明信息界面的左边列表大小不合适
    + 主界面playerpanel各种信息的大小, 与字体大小搭配处理
    + 所有框体的标题
