...
## 2019-7-4-Thursday
1. 完成了闪屏机制, 目前缺闪屏图标, 以及淡入淡出机制. 但是发现场景载入时延迟较高, 此时尚未出现闪屏, 有待优化.
...
4. 为 modalmaker 和 weapon 编辑器补上了名字的字符串选择功能, 现在考虑到便利性, 应在以下界面也加入名字修改的功能: Monster, Player
...
4. 发现 Choice 选择框的组件过于老旧, **需要将ChoiceDlg的列表组件替换为 SelectListView, 并更新代码**

## 2019-12-31-Tuesday
1. 完成 choice 编辑器的代码
2. Modal选择框暂时弃用, 先用Modalmaker, **以后考虑优化后再用ModalSelector**
