...
6. 资源已进行了移动, 现在所有用到的资源(除旧的 Resource/Prefab 引用的 player 资源外), 都在 Assets/Image/Image 中, **未来考虑进一步筛选有用资源, 将无用资源移除**
...
## 2019-6-6-Thursday
1. 完成了存读档功能, 并将存读档的 json 数据结构移动到 Constant.cs 里, 考虑将设置项的数据结构也移动至此
