...
5. 完成上述关键事项后, 另有如下事项需要后续完成:
    + 需要设计应用图标和 ~~ArmyAnt 组织图标, 这两者还需要全屏大图标以用于闪屏展示~~([2019年7月30日](#2019-7-30-Tuesday)完成组织初版简易图标)
    + 需要制作 Miss 和跳数字
...
2. Modal 界面的名字编辑和事件数据编辑需要另外的框体支持, 新添加Modal功能暂时不做, 除此以外其他功能都已经完成
